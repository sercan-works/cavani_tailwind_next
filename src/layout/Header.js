...
const navs = [
  { id: 1, name: "Anasayfa", href: "home" },
  { id: 2, name: "Hakkımızda", href: "about" },
  { id: 3, name: "Eserlerimiz", href: "portfolio" },
  // { id: 4, name: "Hizmetlerimiz", href: "service" },
  { id: 5, name: "Kronoloji", href: "news" },
  { id: 6, name: "İletişim", href: "contact" },
];
        ...
        <div className="topbar_inner w-full h-full clear-both flex items-center justify-between py-0 px-[20px]">
          <div className="logo" data-type="text">
            ...
            <a className="text" href="#">
              {/* <img
                className="max-w-[10px] max-h-[40px]"
        ...
        <div className="inner relative w-full h-full text-right px-[20px] pt-[70px] pb-[20px]">
          <div className="wrapper">
            ...
            <div className="copyright w-full float-left">
              <p className="text-[#333] font-poppins">Copyright © 2025</p>
            </div>
          </div>
        </div>
      </div>
      <div className="cavani_tm_header fixed top-0 left-0 right-0 h-[70px] leading-[70px] bg-white z-[10] flex items-center justify-between py-0 px-[70px] middle:hidden">
        <div className="logo" data-type="text">
          ...
          <a
            ...
            href="#"
          >
            <span className="relative top-[2px]">Gârîbî</span>
          </a>
        </div>
